      ...
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div className="flex space-x-4">
            <a href="#" className="text-gray-400 hover:text-blue-500 text-2xl"><SiFacebook /></a>
            <a href="#" className="text-gray-400 hover:text-sky-400 text-2xl"><FaXTwitter /></a>
            <a href="#" className="text-gray-400 hover:text-pink-500 text-2xl"><FaSquareInstagram /></a>
            <a href="#" className="text-gray-400 hover:text-red-500 text-2xl"><IoLogoYoutube /></a>
          </div>
        </div>
      </div>
